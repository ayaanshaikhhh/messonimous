...
const MessagePage = ({ username }: MessagePageProps) => {
  ...
  // Fill textarea when user clicks a suggestion
  ...
  const handleSuggestMessages = async () => {
    ...
    try {
      ...
      if (
        ...
        // Automatically put first suggestion into textarea
      ...
      const axiosError =
        error as AxiosError<SuggestionResponse>;
